...
#define MAX_TUNNELS 30//Quantidate de tuneis que vai gerar
#define PADDING 1 //Define o espacamento entra os tuneis(0 e o espacamento padrao 1x1):
...
void printPathMap(int m[MAP_HEIGHT][MAP_WIDTH]){
    int i, j;
    //Imprime a matriz, substituindo os valores '1' para espacos em branco e '0' para '#'
